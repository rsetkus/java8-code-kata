...
public class Exercise2Test {
    ...
    private static final int NANOSEX = 100000000;
    ...
    public void localTimeOfHourToNanoSec() {
         ...
         */
        LocalTime localTime = LocalTime.of(23, 7, 3, 1 * NANOSEX);
    ...
    public void localTimeMinusDuration() {
         ...
         */
        Duration duration = Duration.ofHours(3).plusMinutes(30).plusSeconds(20).plusNanos(2 * NANOSEX);
